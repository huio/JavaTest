...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        objectTest.name = "ObjectTest.name";
        System.out.println(objectTest.name);

        ObjectConstructorTest objectConstructorTest = new ObjectConstructorTest(objectTest);
        objectConstructorTest.getName();

        ObjectTest objectTest1 = new ObjectTest("ObjectTest.name1");
        System.out.println(objectTest1.name);
